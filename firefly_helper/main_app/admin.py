...
class StatementFileAdmin(admin.ModelAdmin):
    list_display = ('id', 'created_at', 'statement_file', 'status', 'processed_file','statement_type')
...
class AmazonStatementFileAdmin(admin.ModelAdmin):
    list_display = ('id', 'created_at', 'statement_file','selenoid_session_id','status')
    list_filter = ('created_at','status')

@admin.register(models.AmazonOrderDetail)
class AmazonOrderDetailAdmin(admin.ModelAdmin):
    list_display = ('id', 'order_date', 'order_id','product_title','order_amount','product_link','main_category','category_list','status')
...
class TransactionDataAdmin(admin.ModelAdmin):
    list_display = ('transaction_date', 'transaction_id', 'description', 'amount_debit','amount_credit','statement_file')
