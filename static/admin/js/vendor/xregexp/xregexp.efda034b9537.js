							...
							var output = patternAsRegex.source.replace(
								...
								function ($0, $1, $2, $3, $4) {
									...
									if (subName) {
										...
										if ($1) {
											capName =
												outerCapNames[numOuterCaps];
											outerCapsMap[++numOuterCaps] =
												++numCaps;
					...
					module.exports = function (XRegExp) {
						...
						XRegExp.matchRecursive = function (
							...
							while (true) {
								...
								if (leftMatch || rightMatch) {
									delimStart = (leftMatch || rightMatch)
										.index;
									delimEnd =
										delimStart +
					...
					module.exports = function (XRegExp) {
							...
							function (match, scope, flags) {
								...
								if (match[1] === "P" && match[2]) {
									throw new SyntaxError(
										ERR_DOUBLE_NEG + match[0]
									);
								}
								if (!unicode.hasOwnProperty(slug)) {
									throw new SyntaxError(
										ERR_UNKNOWN_NAME + match[0]
									);
								}
						...
						XRegExp.addUnicodeData = function (data) {
							...
							for (var i = 0; i < data.length; ++i) {
								...
								if (
									!(item.inverseOf || item.bmp || item.astral)
								) {
				...
				function (require, module, exports) {
						...
						pattern = nativ.replace.call(
							...
							function ($0, $1) {
								if (nativ.test.call(/[gy]/, $1)) {
									throw new SyntaxError(
										"Cannot use flag g or y in mode modifier " +
											$0
									);
								}
					...
					XRegExp.cache = function (pattern, flags) {
						...
						return (
							...
							(regexCache[pattern][flags] = XRegExp(
								pattern,
								flags
							))
						);
					...
					XRegExp.replace = function (
						...
						if (isRegex) {
							...
							s2 =
								...
								(search[REGEX_DATA][cacheKey] = copyRegex(
									search,
									{
										addG: !!global,
										removeG: scope === "one",
					...
					XRegExp.union = function (patterns, flags, options) {
						...
						function rewrite(match, paren, backref) {
							var name =
								captureNames[numCaptures - numPriorCaptures];
					...
					XRegExp.addToken(
						...
						function (match) {
							...
							if (!isNaN(match[1])) {
								throw new SyntaxError(
									"Cannot use integer as capture name " +
										match[0]
								);
							}
							if (
