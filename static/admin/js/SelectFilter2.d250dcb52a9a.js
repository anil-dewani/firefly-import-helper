	...
	window.SelectFilter = {
		init: function (field_id, field_name, is_stacked) {
			...
			if (!is_stacked) {
				...
				if (
					j_to_box_style.getPropertyValue("box-sizing") ===
					"border-box"
				) {
					// Add the padding and border to the final height.
					height +=
						parseInt(
							j_to_box_style.getPropertyValue("padding-top"),
							10
						) +
						parseInt(
							j_to_box_style.getPropertyValue("padding-bottom"),
							10
						) +
						parseInt(
							j_to_box_style.getPropertyValue("border-top-width"),
							10
						) +
						parseInt(
							j_to_box_style.getPropertyValue(
								"border-bottom-width"
							),
							10
						);
